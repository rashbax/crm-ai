...
export default function WbFinancePage() {
  ...
  const incomeItems = [
    { labelRu: "Выручка", labelUz: "Tushum", value: breakdown.sales, color: "#a855f7" },
    { labelRu: "Компенсации", labelUz: "Kompensatsiyalar", value: Math.max(0, breakdown.compensations), color: "#c084fc" },
    { labelRu: "Корректировки", labelUz: "Tuzatishlar", value: Math.max(0, breakdown.adjustments), color: "#7ccf9a" },
  ];
  const outcomeItems = [
    { labelRu: "Комиссия WB", labelUz: "WB komissiyasi", value: breakdown.commissions, color: "#7c3aed" },
    { labelRu: "Услуги доставки", labelUz: "Yetkazib berish", value: breakdown.deliveryServices, color: "#e8bc74" },
    { labelRu: "Хранение и приёмка", labelUz: "Saqlash va qabul", value: breakdown.fboServices, color: "#0ea5e9" },
    { labelRu: "Продвижение и реклама", labelUz: "Reklama", value: breakdown.adsPromotion, color: "#ef4a89" },
    { labelRu: "Штрафы и удержания", labelUz: "Jarimalar", value: breakdown.otherServicesFines, color: "#4f46c5" },
  ];
    ...
    return (
      <Layout>
        <div className="p-6 text-sm text-text-muted">
          {lang === "ru" ? "Загрузка финансовых данных Wildberries..." : "Wildberries moliya ma'lumotlari yuklanmoqda..."}
        </div>
      </Layout>
    );
  }
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            {lang === "ru" ? "Wildberries: детальный разбор доходов и расходов" : "Wildberries: daromad va xarajatlar tafsiloti"}
          </p>
        </div>
        <a
          href="/finance"
